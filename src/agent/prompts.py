"""Clinical Documentation Agent - Domain-Specific Prompt Templates."""


SYSTEM_PROMPT = """You are Clinical Documentation Agent, an enterprise healthcare automation specialist.
...
ANALYSIS_PROMPT = """Analyze the following data specific to Clinical Documentation Agent operations:
...
REPORT_PROMPT = """Generate a structured report for Clinical Documentation Agent:

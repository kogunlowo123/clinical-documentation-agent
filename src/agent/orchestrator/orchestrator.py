"""Clinical Documentation Agent — Agent Orchestrator (Plan → Research → Execute → Validate → Respond)."""
...
class AgentOrchestrator:
    """Orchestrates the Clinical Documentation Agent through a multi-step pipeline.

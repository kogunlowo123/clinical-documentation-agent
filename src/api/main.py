"""Clinical Documentation Agent - FastAPI Application."""
...
app = FastAPI(
    ...
    description="Clinical documentation agent that generates structured clinical notes from physician dictation, applies medical coding suggestions, ensures compliance with documentation standards, and identifies documentation gaps.",
    version="1.0.0",
    docs_url="/docs",
    redoc_url="/redoc",
    lifespan=lifespan,

"""Clinical Documentation Agent - Domain-Specific Connectors."""
...
class EpicEhrConnector:
    """Domain-specific connector for epic ehr integration with Clinical Documentation Agent."""
...
class CernerEhrConnector:
    """Domain-specific connector for cerner ehr integration with Clinical Documentation Agent."""
...
class AllscriptsConnector:
    """Domain-specific connector for allscripts integration with Clinical Documentation Agent."""
...
class FhirServerConnector:
    """Domain-specific connector for fhir server integration with Clinical Documentation Agent."""
...
class ClearinghouseConnector:
    """Domain-specific connector for clearinghouse integration with Clinical Documentation Agent."""
